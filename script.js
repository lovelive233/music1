...
// 仅禁止查看源码 + 屏蔽一个木函，不影响页面加载与功能
(function blockSourceOnly() {
    try {
        // 拦截 view-source 协议
        ...
        window.XMLHttpRequest = function() {
            ...
            xhr.open = function(method, url) {
                if (url && String(url).match(/view-source|source|dump/i)) {
                    return;
                }
                _open.call(xhr, method, url);
            };
            return xhr;
        };
        ...
        window.fetch = function(resource, options) {
            ...
            if (url.match(/view-source|source|dump/i)) {
